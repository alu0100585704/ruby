...
#agrego como hash con clave nombre de plato y valor el objeto plato
platos[plato.nombre_plato]=plato

plato = Plato.new  do 
  nombre "Refrescos"
  alimento :descripcion => "Cerveza" ,:gramos => 100  
end
...
plato = Plato.new  do 
  nombre "Entrantes"
  alimento :descripcion => "Camarones (piscifactoria)" ,:gramos => 100
  alimento :descripcion => "Queso" ,:gramos => 200
...
menu1=Menu.new("Combinado nº 1",platos) do 
  descripcion "hamburguesa, papas, refresco"
  componente :descripcion => "Hamburguesa especial de la casa",  
              :precio => 4.25

    componente :descripcion => "Entrantes" , 
                :precio=> 1.75
    componente :descripcion => "Refrescos", 
                :precio => 1.50
  precio 7.50
end
