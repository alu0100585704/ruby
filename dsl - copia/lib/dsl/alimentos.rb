...
#de alimento, por defecto 100g.
    ...
    def to_s
      output=nombre + ": " + "#{@gramos_totales}" + " gramos"
      output << "\n#{'=' * output.size}\n"
      output << "Valor Energetico: #{valorEnergetico} Kilocalorias\n"
      output << "Huella Nutricional: #{hN}\n\n"
      #"El alimento: #{@nombre} \n\n, tiene un valor energetico de #{valorEnergetico} para la cantidad de  #{@gramos_totales} gramos y huella nutricional #{@hN} y #{@kgCO_diario}"        
      output
    end
