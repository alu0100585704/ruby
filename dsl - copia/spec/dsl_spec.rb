...
RSpec.describe Alimentos, "Expectativas de la clase Alimentos" do
...
# }
     ...
     @ingredientesPrimerPlato.insertHead(Alimentos.new("Tofu",Dsl::TABLA['Tofu'],500))
     @ingredientesPrimerPlato.insertHead(Alimentos.new("Cerveza",Dsl::TABLA['Cerveza'],250))        

     #defino los ingredientes segundo plato

     @ingredientesSegundoPlato = Listas.new
     @ingredientesSegundoPlato.insertHead(Alimentos.new("Carne de vaca",Dsl::TABLA['Carne de vaca'],500))
     @ingredientesSegundoPlato.insertHead(Alimentos.new("Huevos",Dsl::TABLA['Huevos'],200))
     
     #defino los ingredientes postre
     @ingredientesPostre = Listas.new        
     @ingredientesPostre.insertHead(Alimentos.new("Nuez",Dsl::TABLA['Nuez'],50))

   
               
   end

    it "Prueba plato DSL" do
      plato = Plato.new  do 
        nombre "Hamburguesa especial de la casa"
        alimento :descripcion => "Carne de vaca" ,:gramos => 100
        alimento :descripcion => "Huevos" ,:gramos =>20
    end
      expect(plato.nombre_plato).to eq("Hamburguesa especial de la casa")
    end

    it "Prueba Menu DSL" do
