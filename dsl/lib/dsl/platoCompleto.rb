...
#    end
    ...
    def to_s
        output=super
        output << "Huella Nutricional: #{hN_plato} kilocalorias\n"
        output << "Impacto Ambiental en Gases efecto Invernadero: #{kgCO_diario_plato} Kg/diario\n"
        output << "Impacto Ambiental en Terreno anual necesario: #{terreno_anual_plato} metros cuadrados/año"
        output
